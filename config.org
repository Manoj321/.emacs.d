...
(global-set-key (kbd "C-c a")
   (lambda() (interactive)(find-file "~/Dropbox/Notes/Arista/arista.org")))

;; Open tasks.org
(global-set-key (kbd "C-c t")
   (lambda() (interactive)(find-file "~/Dropbox/Notes/Arista/gtd.org")))
...
;; enable fly-spell and aut-fill modes for org-mode by default
